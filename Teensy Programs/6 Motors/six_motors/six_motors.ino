  ...
  if (Serial.available() > 0) {
    ...
    switch (command) {
      ...
      case 'H':
        ...
        break;
      case 'I':
        stepper5.move(stepsFor90Degrees);
        Serial.println("Moving Motor 5 90 Degrees clockwise");
        break;
      case 'J':
        stepper5.move(-stepsFor90Degrees);
        Serial.println("Moving Motor 5 90 Degrees counter-clockwise");
        break;
      case 'K':
        stepper6.move(stepsFor90Degrees);
        Serial.println("Moving Motor 5 90 Degrees counter-clockwise");
        break;
      case 'L':
        stepper6.move(-stepsFor90Degrees);
